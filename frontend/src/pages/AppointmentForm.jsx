...
export default function AppointmentForm() {
  ...
  useEffect(() => {
    ...
    console.log("Auto-opening appointment for:", hospitalId);
  }, [hospitalId]);
                ...
                {selectedDoctor.available_slots?.map((t) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl text-[11px] font-bold border transition-all ${disabled ? "bg-slate-200 text-slate-400 cursor-not-allowed" : selectedTime === t ? "bg-teal-600 text-white border-teal-600 shadow-md" : "bg-white border-slate-200 hover:border-teal-500"}`}
                    >
                      {t}
                    </button>
                  );
              ...
              <div className="text-[11px] text-slate-600 space-y-4">
                ...
                <div className="flex justify-between border-b border-slate-100 pb-4">
                  ...
                  <span className="font-bold text-slate-900">
                    ₹
                    {(
                      (selectedDoctor.consultation_fee + PLATFORM_FEE) *
                      GST_RATE
                    ).toFixed(2)}
                  </span>
                </div>
