      ...
      {showForm && (
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-xl animate-in slide-in-from-top-4">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="font-black text-slate-900 text-lg">Register New Staff</h3>
          </div>
          ...
          <button onClick={addStaff} className="mt-6 w-full px-8 py-4 bg-[#0b645b] text-white rounded-2xl font-black text-sm hover:bg-[#084e46] transition-transform active:scale-95">Save Staff Profile</button>
        </div>
      )}
